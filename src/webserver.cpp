...
*/
	...
	rv += make_link(string("/in/") + i->getDescriptor() + "/cycle/3600/" + from + "/" + to + "/2000/600", "cyclic graph last day per hour");
	rv += "<br>\n";

	write_human_time(from, tnow-7*24*3600);
	rv += make_link(string("/in/") + i->getDescriptor() + "/cycle/86400/" + from + "/" + to + "/2000/600", "cyclic graph last week per day");
	rv += "<br>\n";

	write_human_time(from, tnow-4*7*24*3600);
	rv += make_link(string("/in/") + i->getDescriptor() + "/cycle/86400/" + from + "/" + to + "/2000/600", "cyclic graph last month per day");
	rv += "<br>\n";
	
	write_human_time(from, tnow-4*7*24*3600);
	rv += make_link(string("/in/") + i->getDescriptor() + "/cycle/604800/" + from + "/" + to + "/2000/600", "cyclic graph last month per week");
	rv += "<br>\n";	
